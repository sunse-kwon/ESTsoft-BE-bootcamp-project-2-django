...
## 목표
- 싱가포르 여행관련 카페를 Django로 CRUD & 인증 구현 및 배포
...
### 마치며
장고를 배우고, AWS 서버에 띄우는 경험을 처음 경험해보았습니다. 배포 페이지가 뜬 순간 희열이 엄청났으며, 이 경험을 바탕으로 더욱 개발에 정진할 수 있는 동기부여가 된 프로젝트이기에 기억에 많이 남을 것 같습니다.
